		...
		<div class="thanku">
			...
			<div class="container">
				<div class="header">
					...
					<br>
					<div class="button">
						<a href="https://kharagpur.distanceeducationschool.in/"><center>	<button type="button" style="padding: 10px; border: 1px solid black; background-color:#002B5C; color: #fff; font-weight:bold;">For More Information Kindly Visit Here</button></center></a>
					</div><!--end of card-->
